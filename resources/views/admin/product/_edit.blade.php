...
@endsection
@section('content')
    <section class="content" id="edit-product">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control-file" accept="image/*" v-on:change="onFileChange" v-model="mainImage">

                                <img :src="mainImagePreview" v-if="mainImagePreview" alt="Main Image Preview" style="max-width: 100px;">
                    ...
                    <div v-if="showVariantSection">
                        <div class="row mb-3" v-for="(variant, index) in product.variants" :key="index">
                            <div class="col-md-4">
                                <div class="form-group">
...
<script>
    ...
    <script src="{{ asset('controller/edit-product.vue.js') }}?v={{ time() }}"></script>
@endsection
